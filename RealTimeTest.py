...
def RealTimeAudioTest(model):
    ...
    target_samples = fs * duration # DEFAULT_FREQ * DEFAULT_TIME
    ...
    mel_spectrogram = librosa.feature.melspectrogram(y=audio.T,n_fft=2048,hop_length=512,n_mels=64)   
    ...
    labels=['happy','tense','angry','content','neutral','distressed','relex','peaceful','sad']
